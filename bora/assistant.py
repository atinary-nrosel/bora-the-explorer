...
class Comment(BaseComment):
    ...
    def _chat_completion(self, messages: List[Dict[str, str]]) -> str:
        if self._chat_completion_fn is None:
            raise RuntimeError(
                "Comment was constructed without a chat_completion_fn; "
                "cannot retry malformed JSON."
            )
        return self._chat_completion_fn(messages)
        ...
        while n_tries < 5:
            ...
            if len(message) > 0:
                ...
                comment = Comment(
                    ...
                    self._total_tokens,
                    self._random_seed,
                    chat_completion_fn=self._chat_completion,
                )
